(() => {
  ...
  console.log(document.getElementById("hbe-tips"))

  document.getElementById("hbe-tips").addEventListener('click', () => {
    document.getElementById("hbe-container-mask").style.display = "block"
    document.getElementById("hexo-blog-encrypt").style.display = "block"
  });


  document.getElementById("hbe-container-mask").addEventListener('click', () => {
    document.getElementById("hbe-container-mask").style.display = "none"
  ...
  async function decrypt(decryptKey, iv, hmacKey) {
    ...
    const result = await cryptoObj.subtle.decrypt({
      ...
      // 新主题
      document.getElementById('hbe-theme-weixin').style.display = 'none';
      document.getElementById('decode-str').appendChild(await convertHTMLToElement(decoded));
      //document.getElementById('decode-str').appendChild(hideButton);
  ...
  function hbeLoader() {
    ...
    document.getElementById('read-more').addEventListener('click', async () => {
